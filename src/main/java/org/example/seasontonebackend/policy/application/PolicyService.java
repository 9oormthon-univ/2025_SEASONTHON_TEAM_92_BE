    ...
    private List<PolicyResponseDTO.PolicyDetail> getPoliciesByUserRegion(String userRegion) {
        List<PolicyResponseDTO.PolicyDetail> allPolicies = Arrays.asList(
                ...
                PolicyResponseDTO.PolicyDetail.builder()
                        ...
                        .policyName("청년 월세 한시 특별지원")
                        .category("주거지원")
                        .summary("만 19~34세 청년의 월세 부담 완화를 위한 지원")
                        .amountInfo("최대 월 20만원, 12개월")
                        .matchScore(95)
                        .eligibilityStatus("자격 충족")
                        .externalUrl("https://molit.go.kr/youth")
                        .isBookmarked(false)
                ...
                PolicyResponseDTO.PolicyDetail.builder()
                        .policyId(2L)
                        .policyName("청년 전월세보증금 대출")
                        .category("대출지원")
                        .summary("만 34세 이하 청년 대상 전월세보증금 대출")
                        .amountInfo("최대 7천만원, 연 1.8%")
                        .matchScore(88)
                        .eligibilityStatus("자격 충족")
                        .externalUrl("https://hf.go.kr/youth")
                        .isBookmarked(false)
                ...
                PolicyResponseDTO.PolicyDetail.builder()
                        .policyId(3L)
                        .policyName("서울시 청년 주거지원")
                        .category("주거지원")
                        .summary("서울시 거주 청년 대상 주거비 지원")
                        .amountInfo("최대 월 15만원, 24개월")
                        .matchScore(92)
                        .eligibilityStatus("자격 충족")
                        .externalUrl("https://seoul.go.kr/youth-housing")
                        .isBookmarked(false)
