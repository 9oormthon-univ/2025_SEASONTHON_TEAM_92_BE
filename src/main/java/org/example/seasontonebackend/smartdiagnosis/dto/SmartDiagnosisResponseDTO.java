...
public class SmartDiagnosisResponseDTO {
    ...
    public static class MeasurementDetail {
        ...
        private NoiseDetail noiseDetails;
        private InternetDetail internetDetails;
    }
    ...
    @AllArgsConstructor
    @Builder
    public static class NoiseDetail {
        private Double avgDecibel;
        private Double minDecibel;
        private Double maxDecibel;
        private String category;
    ...
    @AllArgsConstructor
    @Builder
    public static class InternetDetail {
        private Double downloadSpeed;
        private Double uploadSpeed;
        private Double ping;
        private String speedGrade;
